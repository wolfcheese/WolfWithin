...
struct ITEM_INFO
{
	...
	short after_death;
	ushort fired_weapon;
	short item_flags[4]; //wc - Lara's item_flags[3] tracks aqua lung visibility
	void* data;
	PHD_3DPOS pos;
	ITEM_LIGHT il;
	ushort active : 1;
	...
	ushort clear_body : 1;
	ushort ai_bits : 5; //wc - Lara's AI bits: bit 1 human/wolf, bit 2 transformation enabled, bit 3 fast travel locked, bit 4 crouch jump enabled, bit 5 aqua lung enabled
