...
void BigGunCollision(short item_number, ITEM_INFO* l, COLL_INFO* coll)
{
	...
	if (CanUseGun(item, l))
	{
		...
		l->frame_number = anims[objects[VEHICLE_ANIM].anim_index + 23].frame_base;
...
long BigGunControl(COLL_INFO* coll)
{
	...
	if (gun->Flags & 2)
	{
		...
		{
			lara_item->anim_number = objects[VEHICLE_ANIM].anim_index + 1 + 23; //wc - combined boat and biggun anims
			lara_item->frame_number = anims[objects[VEHICLE_ANIM].anim_index + 1 + 23].frame_base;
	...
	case BGUNS_GETOFF:
		...
		item->anim_number = lara_item->anim_number + objects[BIGGUN].anim_index - objects[VEHICLE_ANIM].anim_index - 23;
	...
	case BGUNS_UPDOWN:
		lara_item->anim_number = objects[VEHICLE_ANIM].anim_index + 2 + 23;
		lara_item->frame_number = gun->RotX + anims[objects[VEHICLE_ANIM].anim_index + 2 + 23].frame_base;
		item->anim_number = lara_item->anim_number + objects[BIGGUN].anim_index - objects[VEHICLE_ANIM].anim_index - 23;
		item->frame_number = lara_item->frame_number + anims[item->anim_number].frame_base - anims[lara_item->anim_number].frame_base;
