...
void AddFootprint(ITEM_INFO* item)
{
	...
	//wc - add metal step sound for moon shoes if no other sound
	else if(lara_item->ai_bits & 8 && (lara_item->ai_bits & 1) == 0)
		SoundEffect(footsounds[8] + SFX_FOOTSTEPS_MUD, &lara_item->pos, SFX_DEFAULT);
