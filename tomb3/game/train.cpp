...
void TrainControl(short item_number)
{
	...
	{
		item->item_flags[0] = tomb3.gold ? speed : 100; //wc - underwater sub speed for deep sea level
		item->item_flags[1] = tomb3.gold ? speed : 100;
	}
	...
	if (item->item_flags[1] == (tomb3.gold ? speed : 100))
	{
