...
void InitialiseItem(short item_num)
{
	...
	if (savegame.bonus_flag && !DemoPlay && objects[item->object_number].intelligent) //wc - Is this supposed to double enemy health? Adding intelligent check because this was crashing my deep sea level
		item->hit_points *= 2;
